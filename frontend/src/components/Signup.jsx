      ...
      <div className="p-10 m-10 sm:p-15 sm:m-5 w-96 bg-white rounded-lg shadow">
        ...
        <div className="rounded w-full">
          <label htmlFor="firstName">
            ...
            <input className="Input" type="text" value="" id="firstName" />
          </label>
          <label htmlFor="lastName">
            <span className="LabelText">Last Name</span>
            <input className="Input" type="text" value="" id="lastName" />
          </label>
          <label htmlFor="email">
            <span className="LabelText">Email</span>
            <input className="Input" type="text" value="" id="email" />
          </label>
          ...
          <label htmlFor="password">
            ...
            <input className="Input" type="password" id="re-password" />
          </label>
