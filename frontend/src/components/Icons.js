...
function LocationIcon({ sx }) {
  return (
    <Icon viewBox="0 0 1024 1024" sx={{ fontSize: '1.4rem', ...sx }}>
      <path
        fill="#000000"
...
FilterIcon.prototype.propTypes = {
  sx: PropTypes.oneOfType([unknownObjectValidator, PropTypes.oneOf([null])]),
};
...
WorkerIcon.prototype.propTypes = {
  sx: PropTypes.oneOfType([unknownObjectValidator, PropTypes.oneOf([null])]),
};

function FlagIcon({ sx, flagContent }) {
  return (
    <Icon viewBox="0 0 640 480" sx={{ fontSize: '1.4rem', ...sx }}>
      {flagContent}
    </Icon>
  );
}
...
FlagIcon.prototype.propTypes = {
  sx: PropTypes.oneOfType([unknownObjectValidator, PropTypes.oneOf([null])]),
  flagContent: PropTypes.node.isRequired,
};
...
USIcon.prototype.propTypes = {
  sx: PropTypes.oneOfType([unknownObjectValidator, PropTypes.oneOf([null])]),
};

function FullScreenIcon({ sx, exit }) {
  return (
    <Icon viewBox="0 0 16 16" sx={{ fontSize: '1.4rem', ...sx }}>
      {exit ?
